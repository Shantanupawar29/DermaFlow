...
import { LayoutDashboard, Package, ShoppingBag, Users, BarChart3, Shield, Cloud, Database } from 'lucide-react';
...
const AdminDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="flex">
        {/* Sidebar */}
        <div className="w-64 bg-[#4A0E2E] shadow-lg min-h-screen fixed">
